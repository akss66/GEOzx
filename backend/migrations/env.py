...
从 `app.config.settings.database_url` 取连接串（asyncpg），
以 `app.db.Base.metadata` 为 autogenerate 目标，并导入 `app.models` 注册全部模型。
"""
...
import app.models  # noqa: F401  —— 导入以注册模型到 Base.metadata（T3 起生效）
